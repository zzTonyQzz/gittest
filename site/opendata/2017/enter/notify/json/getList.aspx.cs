    ...
    protected void Page_Load(object sender, EventArgs e) {
				...
				if(USER=="admin"&&PWD=="64376235"){
						try {
								...
								conn1.Open();
								string sqlIns = "SELECT teamname,ATTENname,workstyle,teammembernums,workname,token,training,ip,time from [ztPCRCopendata2017] where state = N'0'  order by id asc";
