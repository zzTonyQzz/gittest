								...
								$.ajax({
										...
										success: function (json) {
												if (json.flag === "true") {
														...
														var workFilesUrl = "http://pcrc.library.sh.cn/FileUpload/hqxu/"+json.data[0].workFilesUrl;
														...
														$.each(workPPTUrl,function(index,element){
															var fileUrl =  decodeURIComponent(element).replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&nbsp;/g," ").replace(/&quot;/g,"\"").replace(/&#39;/g,"\'").replace(/\\\\/g,"\\").replace(/\\n/g,"\n").replace(/\\r/g,"\r");
														...
														var workVideoUrl = "http://pcrc.library.sh.cn/FileUpload/hqxu/"+json.data[0].workVideoUrl;
														if(workVideo)
