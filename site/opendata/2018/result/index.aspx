		...
		<script>
			$(document).ready(function(e) {				
				...
				$("#workSubmit").on("click",function(){
					...
					var ppt1 = $("#workPPT>.template-download>td>.name").eq(0).html()?$("#workPPT>.template-download>td>.name").eq(0).html().trim():"";
					var ppt2 = $("#workPPT>.template-download>td>.name").eq(1).html()?$("#workPPT>.template-download>td>.name").eq(1).html().trim():"";
					...
					var workPPT = $("#workPPT>.template-download>td>.name").eq(0).html()?($("#workPPT>.template-download>td>.name").eq(0).html().trim()+"、"+$("#workPPT>.template-download>td>.name").eq(1).html().trim()):"";
					var workPPTUrl = $("#workPPT>.template-download>td>.name").eq(0).data("url")?($("#workPPT>.template-download>td>.name").eq(0).data("url").trim()+"#hqxu#"+$("#workPPT>.template-download>td>.name").eq(1).data("url").trim()):"";
					var workVideo = "";
					var workVideoUrl = "";
