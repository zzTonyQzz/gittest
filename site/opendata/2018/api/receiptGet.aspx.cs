...
public partial class index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
		try
			...
			//执行wkhtmltopdf.exe 
			Process p = System.Diagnostics.Process.Start(@"C:\Program Files (x86)\wkhtmltopdf\bin\wkhtmltopdf.exe", "--page-size A4 --viewport-size 920x1024 --header-left 报名表  --header-right 上海图书馆2017开放数据应用开发竞赛 --footer-center 上海图书馆 "+hqxuUrl + @" D:\shlib\pcrc\zt\opendata\2017\api\temp\" + fileNameWithOutExtention + ".pdf");
